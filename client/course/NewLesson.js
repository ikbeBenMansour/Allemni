...
export default function NewLesson(props) {
  ...
  return (
    <div >
      <Button aria-label="Add Lesson" color="Secondary" variant="contained" onClick={handleClickOpen}>
        <Add/> &nbsp; Nouvelle leçon
      </Button>
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
      <div className={classes.form}>
        <DialogTitle id="form-dialog-title">Ajouter nouvelle leçon</DialogTitle>
        <DialogContent>
